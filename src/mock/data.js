...
export const aboutData = {
  ...
  paragraphThree: 'I am a hard-worker, a passionate and a goal-driven person, who loves what he does and is always looking for better way to do it.',
  resume: 'https://drive.google.com/file/d/1grYaenC8f2ITRZCeDO7A0CsdjvYm1swy/view?usp=sharing', // if no resume, the button will not show up
};
...
export const projectsData = [
  ...
  },
  {
    ...
    info: 'Built in pure HTML and SCSS. One of the most beautiful websites I have ever built. Taught me a lot about using SCSS, components and deviding code',
    info2: '',
  ...
  },
  {
    ...
    img: 'casino.png',
    title: `Casino Page`,
    info: `Built in ReactJS. I used my own custom components starting from a modal component and creating custom modals, ending with custom grids. 
      Each card, tab, and even the numbers are seperate components using different logics to be rendered`,
    info2: '',
    url: 'https://vakhonodadze.github.io/Casino/',
    repo: 'https://github.com/VakhoNodadze/Casino', // if no repo, the button will not show up
  },
];
...
export const blogsData = [
  {
    ...
    url: 'https://medium.com/javascript-in-plain-english/how-react-works-under-the-hood-277356c95e3d',
  },
  {
    id: nanoid(),
    img: 'closures.jpeg',
    ...
    info: `I talk about React and how it works under the hood to show and teach the inside workings about this beautiful library`,
    url: 'https://medium.com/javascript-in-plain-english/closures-in-javascript-47df75ac71a4',
  },
]
// CONTACT DATA
